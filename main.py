...
cpc = row.get("CPC Demand", 0)
roas = row.get("ROAS Demand", 0)
...
# 5. Function to replace text while preserving formatting
...
# 6. Open PowerPoint and apply replacements
...
print("Presentation updated successfully with formatting preserved.")
